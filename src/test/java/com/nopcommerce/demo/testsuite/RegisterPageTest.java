...
public class RegisterPageTest extends BaseTest {
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() throws InterruptedException {
        ...
        //Enter firstname
        registerPage.enterFirstName("Kishan");
        //Enter lastname
        registerPage.enterLastName("Sukhla");
        Thread.sleep(3000);
        //Select day, month and year
        registerPage.selectDateOfBirth("11", "March", "1988");
        //enter email
        registerPage.enterEmail(email);
        Thread.sleep(3000);
        // enter password
        registerPage.enterPassword("Kishan2345");
        Thread.sleep(3000);
        // enter confirm password
        registerPage.enterConfirmPassword("Kishan2345");
        // click on  REGISTER BUTTON
        registerPage.clickOnRegisterButton();
        Thread.sleep(3000);
